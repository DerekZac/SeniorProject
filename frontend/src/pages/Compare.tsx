  ...
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-10">
      ...
      <p className="text-sm mb-8" style={{ color: '#5A5A7A' }}>
        Compare live market data for any two cryptocurrencies side-by-side.
      </p>
          ...
          {([0, 1] as const).map(i => (
            <div key={i} className="flex-1 min-w-[180px] relative">
              ...
              <input
                ...
                style={{ background: '#0F0F1A', border: '1px solid #21213A', color: '#ffffff' }}
...
function MetricRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between py-2.5" style={{ borderBottom: '1px solid #21213A' }}>
